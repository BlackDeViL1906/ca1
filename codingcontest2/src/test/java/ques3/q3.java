...
public class q3 {
	...
	public static void main(String[] args) {
		...
		if(currtitle.equals(expectedTitle)) {
		...
		WebElement textboxl=driver.findElement(By.xpath("//*[@id=\"ap_email\"]"));
		textboxl.sendKeys("9360244678");
		driver.findElement(By.xpath("//*[@id=\"continue\"]")).click();
		WebElement textbox2=driver.findElement(By.xpath("//*[@id=\"ap_password\"]"));
		textbox2.sendKeys("d2k@HariShubha");
