...
public class CC2 {
    public static void main( String[] args ) throws InterruptedException
    {
        ...
        String producttitle = "ASUS TUF Gaming A15, 15.6-inch (39.62 cms) FHD 144Hz, AMD Ryzen 5 4600H, 4GB NVIDIA GeForce GTX 1650, Gaming Laptop (8GB/512GB SSD/Windows 11/Black/2.3 Kg), FA506IHRZ-HN111W : Amazon.in: Computers & Accessories";
        ...
        Thread.sleep(5000); 
        Boolean curr = driver.findElement(By.xpath("//*[@id=\"attach-close_sideSheet-link\"]")).isDisplayed();
        System.out.println("Is item added to cart:" + curr);
        ...
        String prodsign = "Amazon Sign In";
        if(sign.equals(prodsign)) {
